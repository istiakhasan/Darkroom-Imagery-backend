...
-- CreateEnum
CREATE TYPE "ServiceStatusEnum" AS ENUM ('upcomming', 'hot', 'tranding');
...
CREATE TABLE "services" (
    ...
    "status" "ServiceStatusEnum" NOT NULL,
...
-- AddForeignKey
ALTER TABLE "booked_services" ADD CONSTRAINT "booked_services_userEmail_fkey" FOREIGN KEY ("userEmail") REFERENCES "user"("email") ON DELETE RESTRICT ON UPDATE CASCADE;
