...
router.post('/', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), blog_controller_1.blogController.careteBlog);
...
router.patch('/:id', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), blog_controller_1.blogController.updateBlog);
