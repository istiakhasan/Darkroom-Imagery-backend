...
const createService = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (uploadImage) {
        req.body.service_img = uploadImage === null || uploadImage === void 0 ? void 0 : uploadImage.secure_url;
    }
...
const getAllServicesForUsers = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(req.query, ['searchTerm', 'minPrice', 'maxPrice', 'isAvailable', 'status', 'location', 'categoryId']);
    const options = (0, pick_1.default)(req.query, ['limit', 'page', 'sortBy', 'sortOrder']);
